---
layout: page
title: Riccardo De Luca
permalink: /team/riccardo-de-luca/
description: Full profile and recent publications of Riccardo De Luca.
---

{% assign member = site.data.team | where: "slug", "riccardo-de-luca" | first %}
